...
**Routes:** `GET /api/v2/health/workflow-campaign/{id}` (display config) →
[agents.md](https://agents.1health.io/public/prod/api/v2/health/workflow-campaign/_id_/agents.md)
